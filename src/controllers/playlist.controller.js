...
const createPlaylist = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new apiresponse("Playlist created successfully", 201, newPlaylist))
})
...
const getUserPlaylists = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new apiresponse("User playlists fetched",200,playlists))
})
...
const getPlaylistById = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new apiresponse("Playlist fetched successfully", 200, result[0]))
})
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    await Playlist.save()
    return res.status(200).json(new apiresponse("Video added to playlist successfully",200,Playlist))
})
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
    ...
    await Playlist.save()
    return res.status(200).json(new apiresponse("Video removed from playlist successfully",200, Playlist))
})
...
const deletePlaylist = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new apiresponse("Playlist deleted successfully",200, {}))
})
...
const updatePlaylist = asyncHandler(async (req, res) => {
    ...
    await Playlist.save()
    return res.status(200).json(new apiresponse("Playlist updated successfully",200,Playlist))
})
